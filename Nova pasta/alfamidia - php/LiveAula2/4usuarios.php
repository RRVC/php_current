...
<body>
    <section>
        ...
        <form action="4usuarios.php?op=novo" method="post">
            <label for="nome">
            ...
            <?php
                ...
                if( $op == "novo"){
                    ...
                    if(isset($_POST["nome"]) && isset($_POST["usuario"]) && isset($_POST["senha"])){
                        ...
                        $sql = "INSERT INTO usuarios (id, nome, usuario, senha) VALUES (NULL, '$nome', '$usuario', '$senha');";
                        $conn->query($sql);
                        echo "<script>alert('Usuario adicionado com sucesso!'); window.location='home.php';</script>";
                    } else {
